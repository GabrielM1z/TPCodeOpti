...
public interface RestorantApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"rate\" : 0, \"name\" : \"name\", \"id\" : \"id\", \"category\" : \"category\" }";
    ...
    default ResponseEntity<List<Restorant>> listRestorants(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"rate\" : 0, \"name\" : \"name\", \"id\" : \"id\", \"category\" : \"category\" }, { \"rate\" : 0, \"name\" : \"name\", \"id\" : \"id\", \"category\" : \"category\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
